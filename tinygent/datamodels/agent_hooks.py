...
class AgentHooks(ABC):
    ...
    def __init__(self) -> None:
        ...
        self.on_reasoning: Callable[[str], None] = lambda reasoning: _log_hook(
            f'Reasoning: {reasoning}'
        )

        self.on_answer: Callable[[str], None] = lambda answer: _log_hook(
            f'Final Answer: {answer}'
        )

        self.on_error: Callable[[Exception], None] = lambda e: _log_hook(
            f'Error occurred: {e}', level=logging.ERROR
        )
