...
class Query(BaseModel):
    ...
    show_strict_warning: Optional[bool] = Field(
        None,
        description='True if results blocked by strict safesearch setting.'
    )
...
class Properties(BaseModel):
    ...
    placeholder: Optional[str] = Field(
        None, description='The placeholder image URL.'
    )
    width: Optional[int] = Field(
        None, description='The width of the image.'
    )
...
class MetaUrl(BaseModel):
    ...
    favicon: Optional[str] = Field(
        None, description='The favicon used for the URL.'
    )
    path: Optional[str] = Field(
        None, description='The hierarchical path of the URL.'
    )
...
class ImageResult(BaseModel):
    ...
    title: Optional[str] = Field(
        None, description='The title of the image.'
    )
    url: Optional[str] = Field(
    ...
    properties: Optional[Properties] = Field(
        None, description='Metadata for the image.'
    )
...
class ImageSearchApiResponse(BaseModel):
    ...
    extra: Extra = Field(
        ..., description='Additional information about the results.'
    )
