...
_TINY_MINHASH_PERMUTATIONS = int(os.getenv('TINY_MINHASH_PERMUTATIONS', 32))
_TINY_MINHASH_BAND_SIZE = int(os.getenv('TINY_MINHASH_BAND_SIZE', 4))
_TINY_MIN_NAME_LENGTH = int(os.getenv('TINY_MIN_NAME_LENGTH', 6))
_TINY_MIN_TOKEN_COUNT = int(os.getenv('TINY_MIN_TOKEN_COUNT', 2))
_TINY_NAME_ENTROPY_THRESHOLD = float(os.getenv('TINY_NAME_ENTROPY_THRESHOLD', 1.5))
_TINY_FUZZY_JACCARD_THRESHOLD = float(os.getenv('TINY_FUZZY_JACCARD_THRESHOLD', 0.8))
