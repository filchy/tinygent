...
def event_node_2_prompt(event: TinyEventNode | list[TinyEventNode]) -> dict | list[dict]:
...
def entity_node_2_prompt(entity: TinyEntityNode | list[TinyEntityNode]) -> dict | list[dict]:
